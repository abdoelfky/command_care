...
import 'package:command_care/features/splash/presentation/splash_screen.dart';
  ...
  final List<Map<String, String>> onboardingData = [
    {
      ...
      "title": "Access Quality Healthcare Anytime",
      "subtitle":
      "Get connected with top medical professionals right from your device.",
    },
    {
      "image": AppImages.onBoarding2,
      "title": "Schedule Appointments Easily",
      "subtitle":
      "Book consultations with doctors at your convenience, hassle-free.",
    },
    {
      "image": AppImages.onBoarding3,
      "title": "Your Health Records, All in One Place",
      "subtitle":
      "Securely manage and access your medical records anytime, anywhere.",
    },
  ];
